...
team.data <- read.csv("C:\\Users\\Jon\\Documents\\Projects\\m11-dplyr\\exercise-7\\data\\teams.csv", stringsAsFactors = FALSE)
...
team.data <- mutate(team.data, TSR=TOV/STL)

# Sort the teams from lowest turnover/steal ratio to highest
# Which team has the lowest ratio?
team.data <- arrange(team.data, TSR)
